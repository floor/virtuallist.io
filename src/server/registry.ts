...
const LIBRARIES: LibraryInfo[] = [
  ...
  },
  {
    slug: "vlist-react",
    name: "VList (React)",
    tagline: "React useVList hook wrapping the zero-dependency vlist engine",
    ecosystem: "react",
    npm: "vlist-react",
  ...
  },
  {
    ...
    name: "VList (Vue)",
    tagline:
      "Vue 3 useVList composable wrapping the zero-dependency vlist engine",
    ecosystem: "vue",
    npm: "vlist-vue",
  ...
  },
  {
    ...
    name: "VList (SolidJS)",
    tagline:
      "SolidJS createVList primitive wrapping the zero-dependency vlist engine",
    ecosystem: "solid",
    npm: "vlist-solidjs",
  ...
  // ── Svelte Ecosystem ───────────────────────────────────────────────────
  {
    ...
    name: "VList (Svelte)",
    tagline:
      "Svelte use:vlist action wrapping the zero-dependency vlist engine",
    ecosystem: "svelte",
    npm: "vlist-svelte",
  ...
  },
  {
    ...
    npmUrl: "https://www.npmjs.com/package/vlist",
    homepage: "https://vlist.io",
    enabled: true,
    order: 310,
  },
